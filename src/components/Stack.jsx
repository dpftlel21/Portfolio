...
const Stack = () => {
  ...
  const StackContainer =
    "w-[22%] h-[75%] rounded-xl flex flex-col justify-center items-center bg-gradient-to-b from-[#a0b3f3] to-[#c6d7f3]";

  const Language =
    "w-[70%] h-[20%] text-2xl border-b-2 border-solid border-b-gray-400 mb-1";
    ...
    <div className={DetailContainer}>
      <div className={cardContainer}>
        ...
        <div className="w-full h-[80%] flex justify-around items-center">
          ...
          {/* 라이브러리 */}
          <div className={StackContainer}>
            <h1 className={Language}>Library</h1>
            <div className={StackLists}>
              <div className={Stack}>
              ...
              <div className={Stack}>
                <Icon icon="logos:redux" className={StackIcon} />
          ...
          {/* 커뮤니케이션 */}
          <div className={StackContainer}>
            <h1 className={Language}>Communication</h1>
            <div className={StackLists}>
              <div className={Stack}>
                <Icon icon="skill-icons:figma-light" className={StackIcon} />
                <p>Figma</p>
              </div>
            </div>
          </div>
